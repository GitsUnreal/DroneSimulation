...
class SimulationManager:
    ...
    def init_simulation(self, num_drones=2):
        ...
        self.target = TargetFactory.create_random_target(obstacles=self.obstacles)
